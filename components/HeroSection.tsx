      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <div className="mb-10 md:mb-12 px-2 sm:px-4 max-w-[90vw] mx-auto">
            <h1
              className={`text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-light tracking-tight leading-tight break-words text-balance ${
            ...
            >
              {nameText.split("").map((char, index) => (
                <motion.span
                  ...
                  initial="hidden"
                  animate="visible"
                  className={char === " " ? "inline-block w-2 sm:w-4" : "inline-block"}
                  style={{
                    color: index > 5 ? "transparent" : undefined,
                    backgroundImage:
                      index > 5
                        ? "linear-gradient(to right, #007BFF, #00C9FF)"
                        : undefined,
