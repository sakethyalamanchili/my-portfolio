...
//                   theme === "dark"
//                     ? "bg-gradient-to-br from-[#21262D] to-[#1C2128] border-[#30363D] hover:border-yellow-500/50"
//                     : "bg-gradient-to-br from-white to-gray-50 border-[#E5E7EB] hover:border-yellow-400/50"
...
//                     <motion.div
//                       className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-yellow-500 to-orange-500 text-white"
...
//                     <CardTitle
//                       className={`text-lg font-bold mb-2 line-clamp-2 group-hover:text-yellow-500 transition-colors ${
//                         theme === "dark" ? "text-white" : "text-[#1F2937]"
//                       }`}
//                     >
//                       {filter.name}
...
//                         theme === "dark"
//                           ? "bg-[#30363D] text-white hover:bg-[#3C444D] border-[#30363D] hover:border-yellow-500"
//                           : "bg-white text-[#1F2937] hover:bg-[#F3F4F6] border-gray-300 hover:border-yellow-500"
...
//             : "bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-300/30"
//         }`}
//       >
